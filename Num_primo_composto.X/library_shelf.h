...
//struct
//{
//   unsigned int (*celsius)    (void);
//   unsigned int (*kelvin)     (void);
//   unsigned int (*Fahrenheit) (void);
//   
//} value = { celsius_value, kelvin_value, Fahrenheit_value };
